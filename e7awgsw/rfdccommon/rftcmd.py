...
class RftoolCommand(object):
    ...
    def IntrEnable(self, type, tile_id, block_id, interrupt_mask):
        ...
        block_id : int
            ADC/DAC Block ID number
        interrupt_mask : int
            Mask to enable interrupt flag (set bit to clear)
            in ADC
             3- 0 bit : IXR_FIFOUSRDAT_MASK
            11- 4 bit : ADC_IXR_DATAPATH_MASK
            23-16 bit : SUBADC_IXR_DCDR_MASK
    ...
    def IntrDisable(self, type, tile_id, block_id, interrupt_mask):
        """Disable interrupt status of ADC/DAC.
        ...
        block_id : int
            ADC/DAC Block ID number
        interrupt_mask : int
            Mask to disable interrupt flag (set bit to clear)
            in ADC
             3- 0 bit : IXR_FIFOUSRDAT_MASK
            11- 4 bit : ADC_IXR_DATAPATH_MASK
            23-16 bit : SUBADC_IXR_DCDR_MASK
    ...
    def GetDacTileConfig(self, tile_id):
        ...
        Args:
            tile_id (int): 設定を取得する DAC タイルの ID
        ...
        """
        command = self._joinargs("GetDacTileConfig", [tile_id])
