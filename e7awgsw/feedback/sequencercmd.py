...
from e7awgsw.feedback.hwdefs import CaptureParamElem, CaptureUnit, CaptureModule, AWG, FeedbackChannel
from e7awgsw.feedback.hwparam import CLASSIFICATION_RESULT_SIZE, MAX_CAPTURE_SIZE, CAPTURE_RAM_WORD_SIZE, CAPTURE_DATA_ALIGNMENT_SIZE, MAX_WAVE_REGISTRY_ENTRIES, MAX_CAPTURE_PARAM_REGISTRY_ENTRIES
