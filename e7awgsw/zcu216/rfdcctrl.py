...
class RfdcCtrl(RfdcCtrlBase):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            transceiver (RftoolTransceiver): ZCU216 上で動作するプログラムとの通信インタフェースを提供するオブジェクト
            design_type (E7AwgHwType):
    ...
    def _get_dac_interrupts(self, tile: DacTile, channel: DacChannel) -> list[RfdcInterrupt]:
        ...
        if (flags & RfdcIntrpMask.DAC_I_INTP_STG0_OVF or
            ...
            flags & RfdcIntrpMask.DAC_I_INTP_STG3_OVF or
            flags & RfdcIntrpMask.DAC_Q_INTP_STG0_OVF or
            flags & RfdcIntrpMask.DAC_Q_INTP_STG1_OVF or
            flags & RfdcIntrpMask.DAC_Q_INTP_STG2_OVF or
            flags & RfdcIntrpMask.DAC_Q_INTP_STG3_OVF):
        ...
        if (flags & RfdcIntrpMask.DAC_INV_SINC_OVF or
            flags & RfdcIntrpMask.DAC_INV_SINC_EVEN_NYQ_OVF):
        ...
        if (flags & RfdcIntrpMask.DAC_MIXER_I_OVF_UDF or
            flags & RfdcIntrpMask.DAC_MIXER_Q_OVF_UDF):
            interrupts.append(RfdcInterrupt.DAC_MIXER_OVERFLOW_UNDERFLOW)
        if (flags & RfdcIntrpMask.DAC_IMR_OVF):
            interrupts.append(RfdcInterrupt.DAC_IMAGE_REJECTION_OVERFLOW)
    ...
    def __to_interrupt_mask(self, *flags: RfdcInterrupt) -> int:
        ...
        for flag in flags:
            if flag == RfdcInterrupt.DAC_INTERPOLATION_OVERFLOW:
                ...
                mask |= RfdcIntrpMask.DAC_INV_SINC_EVEN_NYQ_OVF
            ...
            elif flag == RfdcInterrupt.DAC_MIXER_OVERFLOW_UNDERFLOW:
                mask |= RfdcIntrpMask.DAC_MIXER_I_OVF_UDF
                mask |= RfdcIntrpMask.DAC_MIXER_Q_OVF_UDF
            elif flag & RfdcInterrupt.DAC_IMAGE_REJECTION_OVERFLOW:
                mask |= RfdcIntrpMask.DAC_IMR_OVF
        return mask
