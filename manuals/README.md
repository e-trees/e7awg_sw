...
スタートトリガは 16 個 の中から選択でき，それぞれが別々の AWG によってユーザ定義波形の出力開始時にアサートされます．

波形データおよびスタートトリガは，キャプチャモジュールと呼ばれる仮想的なモジュールにそれぞれ 1 つずつ入力されます．
...
コンフィギュレーション直後のキャプチャ制御レジスタとキャプチャモジュールの構成は以下のようになっています．
