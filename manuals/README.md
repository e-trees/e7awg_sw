...
#### 前段 FIR フィルタ
I/Q データを I = 実部，Q = 虚部である複素数とみなし，係数が複素数の 16 タップの FIR フィルタを適用します．
...
#### 四値化
2 つの入力データ **I**, **Q** を x-y 平面状の点 (x, y) と対応させたとき，x-y 平面上で 2 本の直線 ①, ② により分割される領域のどこに **(I, Q)** が分類されるか計算します．
