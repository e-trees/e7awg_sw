...
from e7awgsw import DspUnit, CaptureUnit, CaptureModule, AWG, AwgCtrl, \
    CaptureCtrl, WaveSequence, CaptureParam, E7AwgHwType
...
def gen_cos_wave(freq, num_cycles, amp, sampling_rate, smallest_unit_of_wave_len):
    ...
    return IqWave.convert_to_iq_format(i_data, q_data, smallest_unit_of_wave_len)
...
def gen_wave_seq(sampling_rate):
    ...
    num_chunks = 1
    samples = gen_cos_wave(5.0, NUM_WAVE_CYCLES, 32760, sampling_rate, wave_seq.smallest_unit_of_wave_len)
